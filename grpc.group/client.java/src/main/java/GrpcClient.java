...
public class GrpcClient {
    public static void main(String[] args) throws Exception {
        ...
        CreatePersonResponse createResponse = stub.createPerson(CreatePersonRequest.newBuilder().setPerson(person).build());
        System.out.println("Created: " + createResponse.getPerson());

        // Get the person by ID
        GetPersonResponse getResponse = stub.getPerson(GetPersonRequest.newBuilder().setId(createResponse.getPerson().getId()).build());
        ...
        UpdatePersonResponse updateResponse = stub.updatePerson(UpdatePersonRequest.newBuilder().setPerson(updatedPerson).build());
        System.out.println("Updated: " + updateResponse.getPerson());

        // Delete the person
        DeletePersonResponse deleteResponse = stub.deletePerson(DeletePersonRequest.newBuilder().setId(updateResponse.getPerson().getId()).build());
